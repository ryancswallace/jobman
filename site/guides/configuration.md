...
Inspection, lifecycle-emergency commands, `doctor`, `clean JOB`, `clean --all`,
and explicit `clean --older-than` never apply configuration. They remain
available when a configuration file is malformed.
